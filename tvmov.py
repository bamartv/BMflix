...
- Ricerca per titolo
- Filtro per genere
- Clic su locandina apre player in modale fullscreen (video tag con controlli)
...
def build_html(entries):
    parts = [
        ...
        "#playerOverlay video{width:80%;height:auto;outline:none;}",
        ...
        "<video controls id='videoPlayer' src=''></video></div>",
        "<script>",
        ...
        "   }",
        "   videoPlayer.play(); // Play video automatically",
        "}",
        ...
        "   videoPlayer.src=`https://vixsrc.to/tv/${item.id}/${s}/${e}`;",
        "   videoPlayer.play();",
        "}",
        ...
        "function populateGenres(){const set=new Set();",
